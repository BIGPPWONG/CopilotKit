...
const getVersionMismatchErrorMessage = ({
  ...
  `Version mismatch detected: @bigppwong/copilotkit-runtime@${runtimeVersion ?? ""} is not compatible with @bigppwong/copilotkit-react-core@${reactCoreVersion} and @bigppwong/copilotkit-runtime-client-gql@${runtimeClientGqlVersion}. Please ensure all installed copilotkit packages are on the same version.`;
/**
