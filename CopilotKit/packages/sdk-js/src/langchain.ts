console.warn(
  "Warning: '@bigppwong/copilotkit-sdk-js/langchain' is deprecated and will be removed in a future release. Please use '@bigppwong/copilotkit-sdk-js/langgraph' instead.",
);
